...
public class GreaterThanAttribute(int number, string errorMessage) : ValidationAttribute(errorMessage)
{
    ...
    public GreaterThanAttribute(int number) : this(number, DefaultErrorMessageString)
    {
    }
