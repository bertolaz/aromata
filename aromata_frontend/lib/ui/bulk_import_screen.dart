...
import '../viewmodels/bulk_import_viewmodel.dart';
...
class _BulkImportScreenState extends State<BulkImportScreen> {
  late BulkImportViewModel _viewModel;

  @override
  void initState() {
    super.initState();
    _viewModel = BulkImportViewModel(
      bookId: widget.bookId,
      onRecipesImported: widget.onRecipesImported,
    );
  }
  ...
  void _importRecipes() {
    try {
      _viewModel.importSelectedRecipes();
      Navigator.pop(context, _viewModel.extractedRecipes
          .where((r) => _viewModel.selectedRecipeIndices.contains(
              _viewModel.extractedRecipes.indexOf(r)))
          .toList());
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
      value: _viewModel,
      child: Consumer<BulkImportViewModel>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (viewModel.selectedImage == null) ...[
                    ...
                    // Process button
                    ElevatedButton.icon(
                      onPressed: viewModel.isLoading ? null : () => viewModel.processImage(),
                      ...
                      label: Text(viewModel.isLoading ? 'Processing...' : 'Process with AI'),
                      style: ElevatedButton.styleFrom(
                        padding: const EdgeInsets.symmetric(vertical: 16),
                      ),
                    ),
